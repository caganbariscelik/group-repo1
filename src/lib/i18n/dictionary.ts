...
const tr = {
  nav: {
    ...
    sentClaims: "Gönderilen Talepler",
    login: "Giriş Yap",
    logout: "Çıkış Yap",
  },
  footer: {
  ...
  browse: {
    title: "İlanları Gör",
    description: "Açık ilanlarda ara, ya da tür, kategori ve konuma göre filtrele.",
    searchPlaceholder: "Başlık veya açıklamada ara…",
    locationPlaceholder: "Konum, örn. Kütüphane",
    searchBtn: "Ara",
    filterAll: "Tümü",
    ...
    loadErrorPrefix: "İlanlar yüklenemedi: ",
  },
  itemDetail: {
    backToBrowse: "← İlanlara Dön",
    isThisYours: "Bu senin mi?",
    ownListingNote: "Bu senin kendi ilanın.",
    alreadyClaimedPrefix: "Bu ilan için zaten bir talep gönderdin:",
    loginToClaimBtn: "Talep göndermek için giriş yap",
    posted: "Yayınlanma:",
  },
  claimForm: {
    proofLabel: "Sahiplik Kanıtı",
    proofPlaceholder:
      "örn. Cüzdanın içinde mavi bir öğrenci kimliği ve iki banka kartı var.",
    submitBtn: "Talep Gönder",
    submittingBtn: "Gönderiliyor…",
    submittedMessagePrefix: "Talebin gönderildi. Durumunu ",
    submittedLinkLabel: "Gönderilen Talepler",
    submittedMessageSuffix: " sayfasından takip edebilirsin.",
    messageRequired: "Lütfen bir mesaj yaz",
    duplicateClaim: "Bu ilan için zaten bir talep gönderdin.",
  },
  sentClaims: {
    title: "Gönderilen Talepler",
    description: "Bulunan eşyalar için gönderdiğin talepler.",
    emptyStatePrefix: "Henüz hiç talep göndermedin. ",
    browseLink: "İlanlara göz at",
    yourMessageLabel: "Mesajın:",
    sentPrefix: "Gönderilme:",
    acceptedContactPrefix: "Talep kabul edildi — sahibiyle iletişime geç:",
    itemUnavailable: "İlan artık mevcut değil",
    loadErrorPrefix: "Talepler yüklenemedi: ",
  },
  categories: {
...
const en: typeof tr = {
  ...
  browse: {
    title: "Browse Items",
    description: "Search open listings, or filter by type, category, and location.",
    searchPlaceholder: "Search by title or description…",
    locationPlaceholder: "Location, e.g. Library",
    searchBtn: "Search",
    filterAll: "All",
    ...
    loadErrorPrefix: "Couldn't load items: ",
  },
  itemDetail: {
    backToBrowse: "← Back to Browse",
    isThisYours: "Is this yours?",
    ownListingNote: "This is your own listing.",
    alreadyClaimedPrefix: "You already sent a claim for this item:",
    loginToClaimBtn: "Log in to send a claim",
    posted: "Posted:",
  },
  claimForm: {
    proofLabel: "Proof of Ownership",
    proofPlaceholder: "e.g. The wallet contains a blue student ID and two bank cards.",
    submitBtn: "Send Claim",
    submittingBtn: "Sending…",
    submittedMessagePrefix: "Your claim was sent. Track its status on ",
    submittedLinkLabel: "Sent Claims",
    submittedMessageSuffix: ".",
    messageRequired: "Please write a message",
    duplicateClaim: "You already submitted a claim for this item.",
  },
  sentClaims: {
    title: "Sent Claims",
    description: "Claims you've sent for found items.",
    emptyStatePrefix: "You haven't sent any claims yet. ",
    browseLink: "Browse items",
    yourMessageLabel: "Your message:",
    sentPrefix: "Sent",
    acceptedContactPrefix: "Claim accepted — contact the owner:",
    itemUnavailable: "Item no longer available",
    loadErrorPrefix: "Couldn't load your claims: ",
  },
  categories: {
